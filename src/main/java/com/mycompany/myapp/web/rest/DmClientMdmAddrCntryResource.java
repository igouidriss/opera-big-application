...
import com.mycompany.myapp.service.DmClientMdmAddrCntryService;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.DmClientMdmAddrCntry}.
 */
@RestController
@RequestMapping("/api/dm-client-mdm-addr-cntries")
public class DmClientMdmAddrCntryResource {
    ...
    public ResponseEntity<DmClientMdmAddrCntryDTO> createDmClientMdmAddrCntry(
        ...
        dmClientMdmAddrCntryDTO = dmClientMdmAddrCntryService.save(dmClientMdmAddrCntryDTO);
        return ResponseEntity.created(new URI("/api/dm-client-mdm-addr-cntries/" + dmClientMdmAddrCntryDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, dmClientMdmAddrCntryDTO.getId().toString()))
            .body(dmClientMdmAddrCntryDTO);
    }
    ...
    public ResponseEntity<DmClientMdmAddrCntryDTO> updateDmClientMdmAddrCntry(
        ...
        dmClientMdmAddrCntryDTO = dmClientMdmAddrCntryService.update(dmClientMdmAddrCntryDTO);
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<DmClientMdmAddrCntryDTO> getDmClientMdmAddrCntry(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteDmClientMdmAddrCntry(@PathVariable("id") Long id) {
