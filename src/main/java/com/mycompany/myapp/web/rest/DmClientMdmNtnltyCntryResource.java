...
import com.mycompany.myapp.service.DmClientMdmNtnltyCntryService;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.DmClientMdmNtnltyCntry}.
 */
@RestController
@RequestMapping("/api/dm-client-mdm-ntnlty-cntries")
public class DmClientMdmNtnltyCntryResource {
    ...
    public ResponseEntity<DmClientMdmNtnltyCntryDTO> createDmClientMdmNtnltyCntry(
        ...
        dmClientMdmNtnltyCntryDTO = dmClientMdmNtnltyCntryService.save(dmClientMdmNtnltyCntryDTO);
        return ResponseEntity.created(new URI("/api/dm-client-mdm-ntnlty-cntries/" + dmClientMdmNtnltyCntryDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, dmClientMdmNtnltyCntryDTO.getId().toString()))
            .body(dmClientMdmNtnltyCntryDTO);
    }
    ...
    public ResponseEntity<DmClientMdmNtnltyCntryDTO> updateDmClientMdmNtnltyCntry(
        ...
        dmClientMdmNtnltyCntryDTO = dmClientMdmNtnltyCntryService.update(dmClientMdmNtnltyCntryDTO);
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<DmClientMdmNtnltyCntryDTO> getDmClientMdmNtnltyCntry(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteDmClientMdmNtnltyCntry(@PathVariable("id") Long id) {
