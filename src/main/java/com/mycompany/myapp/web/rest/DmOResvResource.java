...
import com.mycompany.myapp.service.DmOResvService;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.DmOResv}.
 */
@RestController
@RequestMapping("/api/dm-o-resvs")
public class DmOResvResource {
    ...
    public ResponseEntity<DmOResvDTO> createDmOResv(@RequestBody DmOResvDTO dmOResvDTO) throws URISyntaxException {
        ...
        dmOResvDTO = dmOResvService.save(dmOResvDTO);
        return ResponseEntity.created(new URI("/api/dm-o-resvs/" + dmOResvDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, dmOResvDTO.getId().toString()))
            .body(dmOResvDTO);
    }
    ...
    public ResponseEntity<DmOResvDTO> updateDmOResv(
        ...
        dmOResvDTO = dmOResvService.update(dmOResvDTO);
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<DmOResvDTO> getDmOResv(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteDmOResv(@PathVariable("id") Long id) {
