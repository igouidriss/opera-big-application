...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dm-o-resv.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DMORESV_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DMORESV actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DMORESV actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DMORESV actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DMORESV actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DMORESV actions', async () => {
      const arg = 42666;
