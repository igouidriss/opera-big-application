...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ft-o-resv.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FTORESV_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FTORESV actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FTORESV actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FTORESV actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FTORESV actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FTORESV actions', async () => {
      const arg = 42666;
