...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './dm-client-mdm-ntnlty-cntry.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DMCLIENTMDMNTNLTYCNTRY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DMCLIENTMDMNTNLTYCNTRY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DMCLIENTMDMNTNLTYCNTRY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DMCLIENTMDMNTNLTYCNTRY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DMCLIENTMDMNTNLTYCNTRY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DMCLIENTMDMNTNLTYCNTRY actions', async () => {
      const arg = 42666;
