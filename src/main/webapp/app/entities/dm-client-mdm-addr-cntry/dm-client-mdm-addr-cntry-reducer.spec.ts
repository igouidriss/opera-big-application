...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './dm-client-mdm-addr-cntry.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DMCLIENTMDMADDRCNTRY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DMCLIENTMDMADDRCNTRY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DMCLIENTMDMADDRCNTRY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DMCLIENTMDMADDRCNTRY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DMCLIENTMDMADDRCNTRY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DMCLIENTMDMADDRCNTRY actions', async () => {
      const arg = 42666;
